...
<table class="ldense" style="margin-top: 3px;">
	...
	<div class="column is-half" style="font-size: 90%; padding-top: 4px;">
		<div style="width: 100%; border: 2px solid #666; margin-bottom: 4px; padding: 2px 5px 5px;">
			<table class="ldense">
				<tr><td class="align-right">Donation Accepted</td><td><?= date('m/d/Y', strtotime($vehicle->dategiventogng)) ?></td>
					<td class="align-right">GNG Location</td><td><?= $glocn ?></td>
					</tr>
			</table>
			<table class="ldense">
				<tr><td class="align-right">Date Donor Informed</td><td><?= date('m/d/Y', strtotime($vehicle->datedonorinformed)) ?></td>
					<td class="align-right">VIP Acceptance</td><td></td>
					</tr>
			</table>
			<table class="ldense">
				<tr><td class="align-right">Initials</td><td style="border: 1px solid #888; width: 80px;"></td>
					<td class="align-right">Borderline Accept?</td><td style="border: 1px solid #888; width: 35px;"></td>
					</tr>
			</table>
		</div>
Body Condition
...
<div style="display: block;">
	...
	<?=$vehicle->pickupdirections?>
		...
		<div style="width: 100%; border: 2px solid #666; margin-top: 4px; padding: 2px 5px 5px;">
			<table class="ldense" style="font-size: 90%;">
				<tr><td class="align-right" style="padding-bottom: 2px; margin-bottom: 2px;">CC Refer?</td><td style="border: 1px solid #888; width: 60px;"></td>
					<td class="align-right">CC Stock #</td><td style="border: 1px solid #888; width: 70px;"></td>
					<td style="border: 1px solid #888; width: 60px;"></td>
					</tr>
			</table>
			<table class="ldense" style="font-size: 85%; margin-top: 3px;">
				<tr><td class="align-right">CC Tow?</td><td style="border: 1px solid #888; width: 70px;"></td>
					<td class="align-right">Ctrl#</td><td style="width: 130px;"></td>
					</tr>
			</table>
		</div>
General Comments
